...
const LoginPage = () => {
  ...
  const handleSubmit = () => {
    if (jawaban === "P3X9T") {
      Swal.fire({
        title: "Selamat!",
        text: "Anda mendapat Tas Bodypack",
        imageUrl:
          "https://tekateki-7otn.vercel.app/static/media/bodypack.jpeg",
        imageWidth: 400,
        imageHeight: 200,
        imageAlt: "philips",
      });
    ...
    <div className={styles.pages}>
      ...
      <Container className={styles.containerHeader}>
        ...
        <Card title="Quest Tantangan">
          <p>
          Selfie Challenge: Ambil selfie dengan ekspresi wajah kocak lalu kirim ke grup WhatsApp kantor dengan caption "Hasil meeting yang serius!"
          </p>
        </Card>
