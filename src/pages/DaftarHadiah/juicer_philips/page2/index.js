...
const LoginPage = () => {
  ...
  const handleSubmit = () => {
    if (jawaban === "W7H2J") {
      Swal.fire({
        title: "Selamat!",
        text: "Anda mendapat juicer philips",
        imageUrl:
          "https://tekateki-7otn.vercel.app/static/media/tgsampah.83ec348bc58c5c600e0a.jpg",
        imageWidth: 400,
        imageHeight: 200,
        imageAlt: "philips",
      });
    ...
    <div className={styles.pages}>
      ...
      <Container className={styles.containerHeader}>
        ...
        <Card title="Quest Tantangan">
          <p>
            Minum dengan Gaya: Minum segelas air sambil bilang "Ahhh mantap!"
            dengan gaya yang gokil.
          </p>
        </Card>
