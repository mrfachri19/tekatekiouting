...
const LoginPage = () => {
  ...
  const handleSubmit = () => {
    if (jawaban === "P3X9T") {
      Swal.fire({
        title: "Selamat!",
        text: "Anda mendapat Aukey PA-B6U-GY",
        imageUrl:
          "https://tekateki-7otn.vercel.app/static/media/auckey.jpg",
        imageWidth: 400,
        imageHeight: 200,
        imageAlt: "philips",
      });
    ...
    <div className={styles.pages}>
      ...
      <Container className={styles.containerHeader}>
        ...
        <Card title="Quest Tantangan">
          <p>
          Lagu Kebangsaan dengan Mulut Tertutup: Nyanyikan lagu kebangsaan atau lagu terkenal, tapi dengan mulut tertutup.
          </p>
        </Card>
