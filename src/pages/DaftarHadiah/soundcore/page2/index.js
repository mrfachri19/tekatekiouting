...
const LoginPage = () => {
  ...
  const handleSubmit = () => {
    if (jawaban === "P3X9T") {
      Swal.fire({
        title: "Selamat!",
        text: "Anda mendapat Anker SoundCore",
        imageUrl:
          "https://tekateki-7otn.vercel.app/static/media/soundcore.jpg",
        imageWidth: 400,
        imageHeight: 200,
        imageAlt: "philips",
      });
    ...
    <div className={styles.pages}>
      ...
      <Container className={styles.containerHeader}>
        ...
        <Card title="Quest Tantangan">
          <p>
            Impersonate Your Boss: Peserta harus menirukan gaya bicara atau
            kebiasaan unik bos selama 30 detik, tanpa membuatnya tersinggung!
          </p>
        </Card>
